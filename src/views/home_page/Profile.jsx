...
const Profile = () => {
    ...
    return (
        <div className="pb-[80px]">
            <div className='pt-6 flex flex-col justify-center items-center bg-gray-700 rounded-b-lg'>
              <div className="relative w-[120px] h-[120px]">
                <img
                  className="absolute inset-0 object-cover rounded-full border-[3px] border-fuchsia-900 w-[120px] h-[120px]"
                  src="user.jpg"
                  alt="Your Image"
                />
              </div>
              <p className="text-center text-lg pt-4 pb-6">Name, 24</p>
            </div>
                ...
                <div className='bg-gray-700 rounded-lg'>
                    <div className='pl-4 pr-2 py-2 flex cursor-pointer' onClick={toggleExpansionPhone}>
                        ...
                        <div className='ml-auto flex items-center'>
                            <p>+7 777 777 77 77</p>
                            <ChevronRightIcon className={`w-4 h-4 ml-2 transition-transform ${isExpandedPhone ? 'rotate-90' : ''}`} />
                        </div>
                    </div>
                    ...
                    <div className='pl-4 pr-2 py-2 flex cursor-pointer' onClick={toggleExpansionEmail}>
                        ...
                        <div className='ml-auto flex items-center'>
                            <p>abcde@ads.ru</p>
                            <ChevronRightIcon className={`w-4 h-4 ml-2 transition-transform ${isExpandedEmail ? 'rotate-90' : ''}`} />
                        </div>
                    </div>
